//
//  LECImagesCollectionViewController.m
//  DoggoApp-objC
//
...
@interface LECImagesCollectionViewController ()

@end

@implementation LECImagesCollectionViewController 
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    //use our custom cell
    LECImageCollectionViewCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:reuseIdentifier forIndexPath:indexPath];
...
-(void)fetchImageURLs
{
    ...
    if(self.subBreed){
        [[LECBreedNetworking sharedController] fetchSubBreedImageURLs:self.subBreed breed:self.breed completion:^(NSArray *fetchedURLs) {
